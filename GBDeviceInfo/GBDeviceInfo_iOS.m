    ...
    // Actual device
        ...
        NSDictionary *modelManifest = @{
            ...
            @"iPad": @{
                ...
                @[@8, @9]: @[@(GBDeviceModeliPadPro11pInch2), @"iPad Pro 4rd Gen (11 inch, WiFi)", @(GBDeviceDisplay11pInch), @264],
                @[@8, @10]: @[@(GBDeviceModeliPadPro11pInch2), @"iPad Pro 4rd Gen (11 inch, WiFi+Cellular)", @(GBDeviceDisplay11pInch), @264],
